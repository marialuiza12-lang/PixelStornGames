...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <CustomHeader pagina={pagina} setPagina={setPagina} />
...
function CustomHeader({ pagina, setPagina }) {
  return (
...
function Home() {
  return (
    <View style={styles.section}>
      ...
      <Text>Aqui você encontrará jogos de todos os tipos</Text>
    </View>
  );
}
...
function Sobre() {
  return (
    <View style={styles.section}>
      ...
      <Text>
        A Pixel Storn Games foi fundada em 2012 e desde então se dedica a criar
        jogos que unem nostalgia retrô com inovação tecnológica.{"\n\n"}
        Seu primeiro título, "Quest of Shadows", conquistou rapidamente uma
        comunidade de jogadores independentes, abrindo caminho para projetos
        maiores. O grande marco veio em 2018, com o lançamento de "StormRiders",
        que alcançou sucesso internacional e levou a empresa a participar das
        principais feiras de games do mundo.{"\n\n"}
        Atualmente, a Pixel Storn Games é reconhecida por suas histórias
        envolventes, mundos vibrantes e jogabilidade criativa, mantendo viva a
        filosofia de que “jogos são feitos de pixels, mas também de sonhos.”
      </Text>
    </View>
  );
}
